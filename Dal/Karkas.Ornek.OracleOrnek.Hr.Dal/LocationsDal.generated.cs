...
public partial class LocationsDal : BaseDal<Locations>
{
	...
	protected override string SelectString
	{
		get 
		{
			return @"SELECT LOCATION_ID,STREET_ADDRESS,POSTAL_CODE,CITY,STATE_PROVINCE,COUNTRY_ID FROM LOCATIONS";
		}
	}
	protected override string DeleteString
	{
		get 
		{
			return @"DELETE   FROM LOCATIONS WHERE LOCATION_ID = :LOCATION_ID ";
		}
	}
